...
export default class MyTaskPopover extends LightningElement {
    ...
    popoverUniqueId = `popover${Date.now() + Math.floor(Math.random() * 100000000000000)
        }`;
