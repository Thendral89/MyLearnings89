({
   ...
   OnSyncFolderFilesToiManage: function (component, event, helper)  {
    ...
    OnNewFolder: function(component,event,helper){
     ...
     OnMultiDocumentToiManageDownload: function(component, event, helper) {
         helper.getmultidocdownloadHelper(component);
    },
   ...
   OnSelectedEmails : function(component,event,helper) {
    ...
    handleUploadFinished: function (component, event, helper)  {
        ...
        //helper.getUploadDocumentDetails(component);
    ...
    handleCheckboxChange: function(component, event, helper) {
        ...
        if (event.getSource().get("v.checked")) {
         ...
         if(selectedItemId!='' && selectedItemId!=null){
       		helper.OnDownloadDocumentsAccessHelper(component,selectedItemId);
         }
